...
/* Blue LED (newly added - 11/01/2019) */
...
static void Board_LED_Init(void)
{
	...
	/* do the same for the green and blue LEDs */
...
void Board_LED_Set(uint8_t LEDNumber, bool On)
{
	...
	if (LEDNumber == 0)
	{
		Chip_GPIO_WritePortBit(LPC_GPIO, LED0_GPIO_PORT_NUM, LED0_GPIO_BIT_NUM, actualOn);
	}
	else if (LEDNumber == 1)
	{
		Chip_GPIO_WritePortBit(LPC_GPIO, LED1_GPIO_PORT_NUM, LED1_GPIO_BIT_NUM, actualOn);
	}
	else if (LEDNumber == 2)
	{
		Chip_GPIO_WritePortBit(LPC_GPIO, LED2_GPIO_PORT_NUM, LED2_GPIO_BIT_NUM, actualOn);
	}
}
...
bool Board_LED_Test(uint8_t LEDNumber)
{
	...
	{
		Chip_GPIO_ReadPortBit(LPC_GPIO, LED1_GPIO_PORT_NUM, LED1_GPIO_BIT_NUM);
	}
	else if (LEDNumber == 2)
	{
